...
import com.example.chatting.Activities.FindFriendsActivity;
    ...
    public void onStart() {
        ...
        final FirebaseRecyclerAdapter<Contacts, ContactsViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull final ContactsViewHolder holder, final int position, @NonNull Contacts model) {
                ...
                /*Button userModel = holder.itemView.findViewById(R.id.userModel);
                userModel.setOnClickListener(new View.OnClickListener() {
                    @Override
